...
using veterNetFram.Presentacion.Reportes;
...
namespace veterNetFram.Presentacion
{
    public partial class frmPrincipal : Form
    {
        ...
        private void listadoAtencionesMesActualToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmListado frmL = new frmListado();
